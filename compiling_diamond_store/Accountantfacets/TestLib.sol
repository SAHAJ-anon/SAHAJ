...
uint16 constant MANAGEMENT_FEE_THRESHOLD = 200;
uint16 constant PERFORMANCE_FEE_THRESHOLD = 5_000;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        address futureFeeManager;
        Fee defaultConfig;
        mapping(address => bool) vaults;
        mapping(address => undefined) customConfig;
