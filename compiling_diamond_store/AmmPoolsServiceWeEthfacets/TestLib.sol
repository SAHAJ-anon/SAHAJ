...
interface IAmmPoolsServiceWeEth {
    function provideLiquidityWeEthToAmmPoolWeEth(
        address beneficiary,
        uint256 usdmAmount
    ) external;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        address weEth;
        address ipWeEth;
        address eEthLiquidityPoolExternal;
        address ammTreasuryWeEth;
        address ammStorageWeEth;
        address iporOracle;
        address iporProtocolRouter;
        uint256 redeemFeeRateWeEth;
        address referral;
    }
