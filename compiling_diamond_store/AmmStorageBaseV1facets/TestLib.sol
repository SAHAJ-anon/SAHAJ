...
interface IAmmStorageBaseV1 {
    ...
    function getBalancesForOpenSwap()
        external
        view
        returns (AmmTypesBaseV1.AmmBalanceForOpenSwap memory);
...
library SoapIndicatorRebalanceLogic {
    ...
    function calculateInterestPaidOut(
        ...
        require(
            ...
            AmmErrors.CALC_TIMESTAMP_LOWER_THAN_SWAP_OPEN_TIMESTAMP
        );
        return
            swapNotional
                .calculateContinuousCompoundInterestUsingRatePeriodMultiplication(
    ...
    function calculateAverageInterestRateWhenOpenSwap(
        ...
        if (averageInterestRate != 0) {
            require(
                ...
                AmmErrors.AVERAGE_INTEREST_RATE_WHEN_OPEN_SWAP_CANNOT_BE_ZERO
            );
        }
    }
...
uint256 constant _DECIMALS_OFFSET_LIQUIDATION_DEPOSIT = 1e12;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint32 _lastSwapId;
        StorageTypesBaseV1.Balance _balance;
        StorageInternalTypes.SoapIndicatorsStorage _soapIndicatorsPayFixed;
        StorageInternalTypes.SoapIndicatorsStorage _soapIndicatorsReceiveFixed;
        StorageInternalTypes.SwapContainer _swapsPayFixed;
        StorageInternalTypes.SwapContainer _swapsReceiveFixed;
        mapping(undefined => undefined) _openedSwapsPayFixed;
        mapping(undefined => undefined) _openedSwapsReceiveFixed;
        uint128 totalLiquidationDepositBalance;
    }
