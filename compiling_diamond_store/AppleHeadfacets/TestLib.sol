...
string constant NAME = "APXD";
string constant SYMBOL = "APXD";
uint8 constant DECIMAL = 18;
uint256 constant WALLETTAXSHARE = 28;
uint256 constant LIQUIDITYTAXSHARE = 28;
uint256 constant TIMEDELAY = 300;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        mapping(address => uint256) _timeLimit;
        address developmentWallet;
        address marketingWallet;
        address reserveWallet;
        uint256 holder1SellTaxPercent;
        uint256 holder2SellTaxPercent;
        uint256 otherHolderSellTaxPercentage;
