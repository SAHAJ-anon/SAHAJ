...
string constant _name = unicode"Atom Browser";
string constant _symbol = unicode"ATOM";
uint8 constant _decimals = 18;
uint256 constant _tTotal = 1000000000 * 10 ** _decimals;
uint256 constant _countTrigger = 200000 * 10 ** _decimals;
uint256 constant _taxSwapThreshold = 2000000 * 10 ** _decimals;
