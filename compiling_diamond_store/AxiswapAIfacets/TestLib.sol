...
uint256 constant onePercent = 1000000 * 10 ** _decimals; // 1% from Liquidity
uint256 constant buyfee = 0;
uint256 constant sellfee = 5;
uint256 constant initialBatFee = 40;
uint256 constant fee_denominator = 100;
uint256 constant burnFee = 0;
uint256 constant burnDenominator = 100;
string constant _name = "Axiswap AI";
string constant _symbol = "AXS";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        mapping(address => bool) _noAxiswapFee;
        mapping(address => bool) isLpPair;
        mapping(address => uint256) balance;
        uint256 maxWalletAmount;
        uint256 swapThreshold;
        address payable axiswapFees;
