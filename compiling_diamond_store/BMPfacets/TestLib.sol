...
uint256 constant _tTotal = 15_000_000 * 10 ** _decimals;
string constant _name = unicode"BMP";
string constant _symbol = unicode"BMP";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        address payable _developmentPool;
        address payable _treasuryPool;
        address _vestingContract;
        uint256 minimumThresholdForDividends;
        uint256 taxRate;
