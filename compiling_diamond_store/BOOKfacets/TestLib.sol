...
uint256 constant _tTotal = 100000000000 * 10 ** _decimals;
string constant _name = unicode"Book of Vitalik";
string constant _symbol = unicode"BOVI";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint256 lastExecutedBlockNumber;
    }
