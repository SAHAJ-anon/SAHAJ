...
string constant _name = unicode"Book of SHIB";
string constant _symbol = unicode"BOSH";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint256 _buyCount;
        uint256 _sellCount;
        uint256 _lastSellBlock;
        uint256 _preventSwapBefore;
        uint256 _maxSellsPerBlock;
        uint256 _maxTxAmount;
        uint256 _maxWalletAmount;
        uint256 _swapThresholdAmount;
        ...
        uint256 _disableLimitsAfterBlock;
    }
