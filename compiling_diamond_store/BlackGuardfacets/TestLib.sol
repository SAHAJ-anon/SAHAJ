...
string constant NAME = "Black Guard";
string constant SYMBOL = "BLG";
uint8 constant DECIMALS = 5;
uint256 constant INITIAL_FRAGMENTS_SUPPLY = 10 ** 5 * 10 ** DECIMALS;
uint256 constant MAX_SUPPLY = 100 * 1e9 * 10 ** DECIMALS;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        mapping(address => undefined) tradeData;
        uint256 mTA;
        uint256 sLP;
        uint256 bLP;
