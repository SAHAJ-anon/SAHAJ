...
import "./TestLib.sol";
contract excludeFromFeesFacet is IERC20, Context, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            if (block.timestamp < ds.launchTime + (2 minutes)) {
                require(ds._earlyBirds[to], "Not early bird!");
            }
            taxAmount = amount.mul(ds.buyTax).div(100);
        }
        ...
        if (
            ...
            taxAmount = amount.mul(ds.sellTax).div(100);
        }
        ...
        if (
            ...
            ds.buyCount > ds._preventSwapBefore &&
            !ds._isExcludedFromFee[to] &&
            !ds._isExcludedFromFee[from]
        ) {
            swapTokensForEth(
