...
library TestLib {
    ...
    struct TestStorage {
        ...
        mapping(address => address) customStrategyTrigger;
        mapping(address => uint256) customStrategyBaseFee;
        mapping(address => mapping(address => address)) customVaultTrigger;
        mapping(address => mapping(address => uint256)) customVaultBaseFee;
    }
