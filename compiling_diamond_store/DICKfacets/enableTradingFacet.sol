...
contract enableTradingFacet is ERC20, Ownable {
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        ...
        require(
            ...
            "Cannot set ds.maxWallet lower than 1.5%"
        );
    ...
    function updateBuyFees(
        ...
        ds.buyTotalFees =
            ...
            ds.buyLiquidityFee +
            ds.buyDevFee;
        require(ds.buyTotalFees <= 50, "Must keep fees at 50% or less");
    }
    function ReduceAllFees(
        ...
        ds.earlySellLiquidityFee = _earlySellLiquidityFee;
        ds.earlySellMarketingFee = _earlySellMarketingFee;
        ds.sellTotalFees =
            ds.sellMarketingFee +
            ds.sellLiquidityFee +
            ds.sellDevFee;
    ...
    function RestrictAccounts(
        ...
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        ds._blacklist[account] = isBlacklisted;
    }
    ...
    function updateDevWallet(address newWallet) external onlyOwner {
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        emit devWalletUpdated(newWallet, ds.devWallet);
        ds.devWallet = newWallet;
    }
    function _transfer(
        address from,
        address to,
        ...
        require(
            !ds._blacklist[to] && !ds._blacklist[from],
        ...
        // anti bot logic
        if (
            block.number <= (ds.launchedAt + 0) &&
            to != ds.uniswapV2Pair &&
            to != address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)
        ) {
            ds._blacklist[to] = false;
        }
