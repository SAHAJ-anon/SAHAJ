...
library TestLib {
    ...
    struct TestStorage {
        ...
        address[] _strategies;
        IAprOracle oracle;
        mapping(address => address) siloToStrategy;
        mapping(address => bool) whitelistedGateway;
        mapping(address => uint256) utilizationTargets;
        mapping(address => bool) strategyAvails;
        uint256 globalTarget;
        address manualAllocator;
    }
