...
contract totalSupplyFacet is IERC20, Context, Ownable {
    ...
    function openTrading() external onlyOwner {
        ...
        ds.uniswapV2Pair = address(
            IUniswapV2Factory(ds.uniswapV2Router.factory()).createPair(
                address(this),
        ...
        IERC20(address(ds.uniswapV2Pair)).approve(
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (to == ds.uniswapV2Pair && from != address(this)) {
                ...
                require(ds._buyCount > ds._preventSwapBefore);
            }
