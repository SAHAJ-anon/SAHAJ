...
import "./TestLib.sol";
contract updateFeeAddressFacet {
    ...
    function updateFeeAddress(address newFeeAddress) external {
        ...
        require(
            msg.sender == ds.feeAddress,
            "Set: You do not have right permission"
        );
        emit UpdatedFeeAddress(ds.feeAddress, newFeeAddress);
        ds.feeAddress = newFeeAddress;
    }
}
