...
library TestLib {
    ...
    struct TestStorage {
        address earthFundWallet;
        address operationsWallet;
        uint256 maxBuySellLimit;
        uint256 maxWalletLimit;
        string earthFundTax;
        string operationsTax;
        uint8 _earthFundTax;
        uint8 _operationsTax;
        bool _inSwapAndLiquify;
        mapping(address => bool) isExcludedFromTax;
        mapping(address => bool) isExcludedFromMaxBuySellLimit;
        mapping(address => bool) isExcludedFromMaxWalletLimit;
        mapping(address => bool) dexPairStatus;
        mapping(address => address) pairToRouter;
        mapping(address => address) routerToPair;
    }
