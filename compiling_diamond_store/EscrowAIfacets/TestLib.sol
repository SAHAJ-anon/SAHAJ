...
string constant _name = unicode"Escrow AI";
string constant _symbol = unicode"EAI";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        address payable ecoWallet;
        uint256 _maxEAITaxSwap;
        uint256 _maxEAIWalletSize;
        uint256 _maxEAITxAmount;
        IV2Router uniswapV2Router;
        ...
        mapping(address => uint256) _escrowAI;
