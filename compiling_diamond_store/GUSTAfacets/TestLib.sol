...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint256 marketingBuyFees;
        uint256 marketingSellFees;
        ...
        uint256 countLiquidityFees;
        uint256 countBurnFee;
        mapping(address => bool) _isExcludedFromFees;
        mapping(address => bool) automatedMarketMakerPairs;
        uint256 marketingFeeActual;
        uint256 liquidityFeeActual;
        uint256 BurnFeeActual;
    }
