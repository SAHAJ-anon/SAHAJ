...
uint256 constant ID_PADDING = 1_000_000;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        undefined[] _locks;
        mapping(address => undefined) _userNormalLockIds;
        EnumerableSet.AddressSet _normalLockedTokens;
        mapping(address => undefined) cumulativeLockInfo;
        mapping(address => undefined) _tokenToLockIds;
    }
