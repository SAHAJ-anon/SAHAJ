...
string constant _name = unicode"Hash VPN";
string constant _symbol = unicode"HVPN";
uint8 constant _decimals = 18;
uint256 constant _tTotal = 100000000 * 10 ** _decimals;
uint256 constant _countTrigger = 5000 * 10 ** _decimals;
uint256 constant _taxSwapThreshold = 5000 * 10 ** _decimals;
