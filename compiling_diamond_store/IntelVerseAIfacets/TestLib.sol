...
string constant _name = unicode"IntelVerse AI";
string constant _symbol = unicode"IVAI";
...
library TestLib {
    ...
    struct TestStorage {
        mapping(address => uint256) _intelVerses;
        mapping(address => mapping(address => uint256)) _allowances;
        mapping(address => bool) _isFeeExcepted;
        uint256 minTXSwaps;
        uint256 maxTXSwaps;
        uint256 maxTXLimits;
        uint256 buyCounts;
        uint256 buyTaxFees;
        uint256 sellTaxFees;
        IUniV2Router uniswapV2Router;
        address uniswapV2Pair;
        bool inSwapLock;
        bool tradeOpen;
        bool swapEnabled;
        address payable taxOperator;
        address payable teamOperator;
    }
