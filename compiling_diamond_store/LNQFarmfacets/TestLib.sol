...
uint256 constant REWARDS_PRECISION = 1e18; // A big number to perform mul and div operations
...
library TestLib {
    ...
    struct TestStorage {
        IERC20 LNQToken;
        undefined[] pools;
        uint256[3] rewardTokensPerBlock;
        uint256[3] lockTime;
        mapping(uint256 => mapping(address => undefined)) poolStakers;
    }
