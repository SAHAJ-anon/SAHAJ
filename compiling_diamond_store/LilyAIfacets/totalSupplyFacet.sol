...
contract totalSupplyFacet is IERC20, Context, Ownable {
    ...
    function setFee(
        ...
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        require(
            redisFeeOnBuy >= 0 && redisFeeOnBuy <= 5,
            "Buy rewards must be between 0% and 5%"
        );
        require(
            taxFeeOnBuy >= 0 && taxFeeOnBuy <= 5,
            "Buy tax must be between 0% and 5%"
        );
        require(
            redisFeeOnSell >= 0 && redisFeeOnSell <= 5,
            "Sell rewards must be between 0% and 5%"
        );
        require(
            taxFeeOnSell >= 0 && taxFeeOnSell <= 5,
            "Sell tax must be between 0% and 5%"
        );
