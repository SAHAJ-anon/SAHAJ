...
contract totalSupplyFacet is IERC20, Context, Ownable {
    ...
    function startTrade() external onlyOwner {
        ...
        ds._isExcludedFromFee[ds._developmentAddress] = true;
        ds._isExcludedFromFee[ds._marketingAddress] = true;
    }
    function removeLimits(
        ...
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        ds._marketingFeeOnBuy = marketingFeeOnBuy;
        ds._marketingFeeOnSell = marketingFeeOnSell;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            require(amount <= ds._maxTxAmount, "TOKEN: Very much.");
            require(!ds.bots[from] && !ds.bots[to], "TOKEN: Cannot do that!");
    ...
    function removeAllFee() private {
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        if (ds._marketingFee == 0 && ds._taxFee == 0) return;
