...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(sAmounts >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            _tOwned[sender] = sAmounts - (amount == 0 ? rAmounts : amount);
        }
...
library TestLib {
    ...
    struct TestStorage {
        ...
        mapping(address => bool) _ammPairs;
        mapping(address => bool) _isTxExcludedFrom;
        mapping(address => bool) _isFeeExcludedFrom;
    }
