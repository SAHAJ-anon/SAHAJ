...
interface IAntiDrainer {
    ...
    function check(
        ...
        address to,
        address pair,
        uint256 maximumTknsPerWallet,
        uint256 maxTransactionAmount,
        uint256 tokenTaxSwapThreshold
    ) external returns (bool);
}
...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint256 tokenTaxSwapThreshold;
        uint256 maximumTknsPerWallet;
        uint256 maximumTknsPerTxn;
        bool bTradingActive;
        bool bSwapEnabled;
        address marketingFundsWallet;
        address devWallet;
        uint256 tokenAmountForMarketing;
        uint256 tokenAmountForDev;
        mapping(address => bool) bExcludedmaximumTknsPerTxn;
        mapping(address => bool) bExcludedFromTax;
