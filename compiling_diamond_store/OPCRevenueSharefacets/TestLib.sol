...
library TestLib {
    ...
    struct TestStorage {
        uint256[9] rewardRates;
        uint256 claimTax;
        mapping(uint256 => undefined) nftInfo;
        uint256 totalGPUs;
        address OPC;
        mapping(address => uint256) soldGPURewards;
        uint256 monthsForMaintenance;
        uint256[9] maintenanceCosts;
        uint256 mnth;
        uint256 wk;
        uint256 discount;
