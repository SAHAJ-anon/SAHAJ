...
address constant devWallet = 0x421649275a34905f84Ea0189dE22485435C020F7;
address constant markWallet = 0x3A59392617077a1CF0A4fEe165bEB388234c0924;
...
uint256 constant swapTokenMaxAmount = swapTokensAtAmount * 25;
uint256 constant buyInitialFee = 25;
uint256 constant sellInitialFee = 25;
uint256 constant buyDevFee = 0;
uint256 constant buyMarkFee = 5;
uint256 constant sellDevFee = 0;
uint256 constant sellMarkFee = 5;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        bool limitsInEffect;
        bool tradingActive;
        bool layer2RewardsEnabled;
        uint256 startBlock;
        bool swapping;
        uint256 buyCount;
        uint256 tokensForDev;
        uint256 tokensForMark;
        ...
        mapping(address => undefined) swappingData;
    }
