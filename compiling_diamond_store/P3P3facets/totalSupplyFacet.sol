...
contract totalSupplyFacet is ERC20, Ownable {
    ...
    function removeMaxLimits() external onlyOwner {
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        ds._maxWalletToken = 420690000000000 * (10 ** _decimals);
        ds._maxTxAmount = 420690000000000 * (10 ** _decimals);
    }
    ...
    function updateTaxBreakdown(
        ...
        require(
            ds.totalFee < ds.feeDenominator / 5,
            "Fees can not be more than 20%"
        );
    }
