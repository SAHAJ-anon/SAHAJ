...
uint256 constant SUPPLY = 7777;
uint256 constant ADMIN_RESERVE = 150;
uint256 constant FREE_MINT_RESERVE = 150;
uint256 constant WL_MINT_RESERVE = 1000;
...
library TestLib {
    ...
    struct TestStorage {
        ...
        string metadataTwoBaseURI;
        string unRevealedURI;
        uint256 mint_price;
        uint256 wl_mint_price;
        uint256 mint_price_discounted;
        uint256 wl_mint_price_discounted;
        uint8 claim_limit;
        uint8 wl_claim_limit;
        uint8 tx_limit;
        uint8 numberOfFreeMint;
        uint8 numberOfWlMint;
        SaleConfig saleConfig;
        bool revealed;
        bytes32 merkleRoot;
        bytes32 wl_merkleRoot;
        mapping(uint256 => undefined) metaType;
        mapping(address => uint8) claimed;
        mapping(address => uint8) wl_claimed;
    }
