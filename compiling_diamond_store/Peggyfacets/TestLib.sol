...
library TestLib {
    ...
    struct TestStorage {
        bytes32 state_lastValsetCheckpoint;
        mapping(address => uint256) state_lastBatchNonces;
        mapping(bytes32 => uint256) state_invalidationMapping;
        uint256 state_lastValsetNonce;
        uint256 state_lastEventNonce;
        bytes32 state_peggyId;
        uint256 state_powerThreshold;
    }
