...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint256 _initialMarketingBuyTax;
        uint256 _antiWhaleBuyTax;
        uint256 _buyCount;
        uint256 _marketingSellTax;
        uint256 _initialMarketingSellTax;
        uint256 _antiWhaleSellTax;
        uint256 _sellCount;
        uint256 taxFee;
        uint256 totalFees;
        ...
        mapping(address => uint256) _rBalances;
