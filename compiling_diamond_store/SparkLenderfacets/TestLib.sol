...
IPool constant lendingPool = IPool(0xC13e21B648A5Ee794902342038FF3aDAB66BE987);
IStakedAave constant stkAave = IStakedAave(
...
library TestLib {
    ...
    struct TestStorage {
        ...
        bool claimRewards;
        bool useAuction;
        mapping(address => uint256) minAmountToSellMapping;
    }
