...
library TestLib {
    ...
    struct TestStorage {
        ...
        uint256 _maxBuyTxAmount;
        uint256 _maxSellTxAmount;
        uint256 _maxWalletSize;
        mapping(address => uint256) _balances;
        mapping(address => mapping(address => uint256)) _allowances;
        mapping(uint256 => uint256) swapBackCounter;
        uint256 swapBackRateLimit;
        mapping(address => bool) isFeeExempt;
        mapping(address => bool) isTxLimitExempt;
        mapping(address => bool) isLiquidityCreator;
        ...
        bool transferTax;
        address payable liquidityFeeReceiver;
