...
string constant _name = "Synthesis AI";
string constant _symbol = "SYNAI";
uint256 constant minSwap = onePercent / 2000; //0.05% from Liquidity supply
