...
uint256 constant _initialBuyTax = 15;
uint256 constant _initialSellTax = 15;
uint256 constant _reduceBuyTaxAt = 11;
uint256 constant _reduceSellTaxAt = 11;
uint256 constant _preventSwapBefore = 11;
uint8 constant _decimals = 9;
uint256 constant _tTotal = 100000000 * 10 ** _decimals;
string constant _name = unicode"TectraAI";
string constant _symbol = unicode"TCAI";
