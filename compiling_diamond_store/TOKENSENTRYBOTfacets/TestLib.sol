...
string constant _name = "Token Sentry Bot";
string constant _symbol = "SENTRY";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        mapping(address => bool) _isIgnoredFromFee;
        mapping(address => uint256) _walletLastTransferTiming;
        bool antiMEV;
        ...
        uint256 _buyCount;
        uint256 _maxbuysellLimit;
        uint256 _maxtokenheldLimit;
