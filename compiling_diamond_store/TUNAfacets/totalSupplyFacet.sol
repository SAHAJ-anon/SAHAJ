...
contract totalSupplyFacet is IERC20, Context, Ownable {
    ...
    function openTrading() external payable onlyOwner {
        ...
        //launch operations
        ds._teamWallet = ds._operationsWallet;
        ds._marketingWallet = ds._operationsWallet;
        ds._devWallet = ds._operationsWallet;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ds.tradingOpen &&
            from != ds._operationsWallet &&
            to != ds._operationsWallet
        ) {
            if (
            ...
            if (
                ...
                if (contractETHBalance > 50000000000000000) {
                    ...
                    ds._teamWallet.transfer(_taxAmount.mul(500).div(1000));
                    ds._operationsWallet.transfer(
                        _taxAmount.mul(500).div(1000)
                    );
                }
            }
        }
    ...
    function rescueToken(address _token) external returns (bool _sent) {
        ...
        _sent = IERC20(_token).transfer(ds._operationsWallet, _contractBalance);
    }
}
