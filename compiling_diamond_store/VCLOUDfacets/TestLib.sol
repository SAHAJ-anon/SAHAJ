...
string constant _name = unicode"Verism Cloud";
string constant _symbol = unicode"VCLOUD";
...
library TestLib {
    ...
    struct TestStorage {
        uint256 _maxVCLOUDSwap;
        uint256 _maxVCLOUDTrans;
        uint256 _maxVCLOUDWallet;
        ...
        mapping(address => bool) isExceptedFromLimit;
        mapping(address => bool) isExceptedFromFee;
        mapping(address => uint256) _holderLastTransferTimestamp;
        address payable lpReceiver;
        address payable opReceiver;
        IVCLOUDRouter uniswapV2Router;
        address uniswapV2Pair;
        uint256 routeAmounts;
        bool tradeOpen;
        bool inSwapBack;
