...
uint256 constant _tTotal = 19780000 * 10 ** _decimals;
string constant _name = unicode"Volodymyr Zelenskyy";
string constant _symbol = unicode"ZELENSKYY";
...
library TestLib {
    ...
    struct TestStorage {
        ...
        address payable _deployerWallet;
        uint256 _taxWalletPercentage;
