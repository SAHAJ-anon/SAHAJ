...
contract enableTradingFacet is ERC20, Ownable {
    ...
    function enableTrading() external onlyOwner {
        ...
        ds.swapEnabled = true;
        ds.tradingActiveTimestamp = block.timestamp;
    }
    ...
    function updateSellFees(
        ...
        require(ds.sellTotalFees <= 35, "Must keep fees at 75% or less");
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            // on buy
            else if (ds.automatedMarketMakerPairs[from] && ds.tradingActive) {
    ...
    function _getBuyTax() internal view returns (uint256) {
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        uint256 timeSinceLaunch = block.timestamp - ds.tradingActiveTimestamp;
