...
import "./TestLib.sol";
contract setTaxFacet is IERC20, Context, Ownable {
    ...
    function setTax(uint8 _newBuyTax, uint8 _newSellTax) public onlyOwner {
        TestLib.TestStorage storage ds = TestLib.diamondStorage();
        ds._SellTax = _newSellTax;
        ds._BuyTax = _newBuyTax;
    }
    ...
    function openTrading() external onlyOwner {
        ...
        ds._maxTxAmount = ds._tTotal.div(3);
        ds._maxWalletSize = ds._tTotal.div(3);
        emit MaxTxAmountUpdated(ds._tTotal);
        ds.swapEnabled = true;
        ds.tradingOpen = true;
    }
