...
contract allowanceFacet {
    ...
    function deposit(
        ...
        if (lockupPeriod == 1) {
            ...
            require(
                amount >= 5 * 10 ** 21 && amount <= 12 * 10 ** 21,
            ...
            require(
                amount >= 15 * 10 ** 21 && amount <= 5 * 10 ** 22,
                "Invalid deposit amount for 365-day lockup."
            );
