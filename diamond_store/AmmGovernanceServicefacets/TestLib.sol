...
interface IAmmGovernanceLens {
    ...
    function getAmmPoolsParams(
        address asset
    ) external view returns (AmmPoolsParamsConfiguration memory);
}
...
library TestLib {
    ...
    struct TestStorage {
        ...
        address _usdtAmmStorage;
        address _usdtAmmTreasury;
        address _usdtAmmPoolsTreasury;
        address _usdtAmmPoolsTreasuryManager;
        address _usdtAmmCharlieTreasury;
        address _usdtAmmCharlieTreasuryManager;
        address _usdc;
        uint256 _usdcDecimals;
        address _usdcAmmStorage;
        address _usdcAmmTreasury;
        address _usdcAmmPoolsTreasury;
        address _usdcAmmPoolsTreasuryManager;
        address _usdcAmmCharlieTreasury;
        address _usdcAmmCharlieTreasuryManager;
        address _dai;
        uint256 _daiDecimals;
        address _daiAmmStorage;
        address _daiAmmTreasury;
        address _daiAmmPoolsTreasury;
        address _daiAmmPoolsTreasuryManager;
        address _daiAmmCharlieTreasury;
        address _daiAmmCharlieTreasuryManager;
        address _stEth;
        uint256 _stEthDecimals;
        address _stEthAmmStorage;
        address _stEthAmmTreasury;
        address _stEthAmmPoolsTreasury;
        address _stEthAmmPoolsTreasuryManager;
        address _stEthAmmCharlieTreasury;
        address _stEthAmmCharlieTreasuryManager;
        address _weEth;
        uint256 _weEthDecimals;
        address _weEthAmmStorage;
        address _weEthAmmTreasury;
        address _weEthAmmPoolsTreasury;
        address _weEthAmmPoolsTreasuryManager;
        address _weEthAmmCharlieTreasury;
        address _weEthAmmCharlieTreasuryManager;
        address _usdm;
        uint256 _usdmDecimals;
        address _usdmAmmStorage;
        address _usdmAmmTreasury;
        address _usdmAmmPoolsTreasury;
        address _usdmAmmPoolsTreasuryManager;
        address _usdmAmmCharlieTreasury;
        address _usdmAmmCharlieTreasuryManager;
    }
