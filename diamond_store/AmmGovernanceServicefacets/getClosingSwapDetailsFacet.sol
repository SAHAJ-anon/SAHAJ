...
import "./TestLib.sol";
contract getClosingSwapDetailsFacet {
    function getClosingSwapDetails(
        address asset,
        address account,
        AmmTypes.TestLib.SwapDirection direction,
        uint256 swapId,
        uint256 closeTimestamp,
        AmmTypes.TestLib.CloseSwapRiskIndicatorsInput
            calldata riskIndicatorsInput
    )
        external
        view
        returns (AmmTypes.TestLib.ClosingSwapDetails memory closingSwapDetails);
}
