...
import "./TestLib.sol";
contract getSoapIndicatorsFacet {
    function getSoapIndicators()
        external
        view
        returns (
            AmmStorageTypes.TestLib.SoapIndicators memory indicatorsPayFixed,
            AmmStorageTypes.TestLib.SoapIndicators memory indicatorsReceiveFixed
        );
}
