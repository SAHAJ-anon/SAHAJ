...
import "./TestLib.sol";
contract updateStorageWhenCloseSwapReceiveFixedInternalFacet {
    function updateStorageWhenCloseSwapReceiveFixedInternal(
        AmmTypes.TestLib.Swap memory swap,
        int256 pnlValue,
        uint256 swapUnwindFeeLPAmount,
        uint256 swapUnwindFeeTreasuryAmount,
        uint256 closingTimestamp
        ...
        external
        returns (AmmInternalTypes.TestLib.OpenSwapItem memory closedSwap);
}
