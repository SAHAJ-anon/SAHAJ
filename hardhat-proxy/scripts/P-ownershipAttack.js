...
async function main() {
  ...
  console.log("Initial Apartment Price:", initialPrice);

  // Attacker updates the price
  const newPrice = parseEther("4");
  ...
  console.log("Updated Apartment Price:", updatedPrice);

  // Test: Verify the price got updated
  expect(updatedPrice).to.equal(newPrice);
  console.log("Price successfully updated to:", updatedPrice);
