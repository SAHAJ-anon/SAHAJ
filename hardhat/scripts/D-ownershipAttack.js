...
async function main() {
  ...
  // Check the current apartment price using getApartmentPrice function
  const initialPrice = await realEstatePrice.getApartmentPrice();
  ...
  // Check if the price actually got updated using getApartmentPrice function
  const updatedPrice = await realEstatePrice.getApartmentPrice();
